...
class TemporalTransformerLayer(nn.Module):
    def __init__(self, hidden_dim, mlp_ratio, num_heads=4, dropout=0.1):
        ...
        self.crit = nn.Linear(1, hidden_dim)

    # def forward(self, src, condition, side_info, training=True):
    def forward(self, src, condition, side_info, input_crit, training=True):
        """
        ...
        src_attn = src + dpe.unsqueeze(1) + tpe[:, L:L+1, :] + spe + self.crit(input_crit)
